  ...
  <Layout>
    <template #left-content>
          ...
          <div class="part-list">
            ...
            <template v-for="contact in item.contactData">
              <div :class="[
                ...
                <Avatar :userId="contact[item.contactId]" :width="35" :showImage="false"></Avatar>
                <div class="text">
      ...
      <div class="search-list" v-show="searchKey">
        <ContactSearchResult @click="searchClickHandler(item)" :data="item" v-for="item in searchList">
        </ContactSearchResult>
      </div>
    </template>

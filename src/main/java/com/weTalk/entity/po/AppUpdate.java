...
public class AppUpdate implements Serializable {
    ...
    /**
     * 把属性updateDesc转换成String数组updateDescArray
     */
    ...
    public String toString() {
        return "自增ID:" + (id == null ? "空" : id) + "，版本号:" + (version == null ? "空" : version) + "，更新描述:" + (updateDesc == null ? "空" : updateDesc) + "，创建时间:" + (createTime == null ? "空" : DateUtil.format(createTime, DateTimePatternEnum.YYYY_MM_DD_HH_MM_SS.getPattern())) + "，0:未发布 1:灰度发布 2:全网发布:" + (status == null ? "空" : status) + "，灰度uid:" + (grayscaleUid == null ? "空" : grayscaleUid) + "，文件类型0:本地文件 1:外链:" + (fileType == null ? "空" : fileType) + "，外联地址:" + (outerLink == null ? "空" : outerLink);
    }
}

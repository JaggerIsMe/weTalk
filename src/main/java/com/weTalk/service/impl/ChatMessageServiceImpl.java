...
import com.weTalk.ai.service.AIAsyncSendMsg;
...
public class ChatMessageServiceImpl implements ChatMessageService {
    ...
    @Resource
    private AIAsyncSendMsg aiAsyncSendMsg;
    ...
    public MessageSendDto saveMessage(ChatMessage chatMessage, TokenUserInfoDto tokenUserInfoDto) {
        ...
        if (Constants.ROBOT_UID.equals(receiveId)){
            ...
            aiAsyncSendMsg.asyncSendMsg(sessionId, messageSendDto, robotChatMessage, robot);
        }
